            ...
            <form role="form" action="{{URL::to(('/update-order/'.$details->order_id))}}" method="post" enctype="multipart/form-data">
                <div class="form-group col-sm-6">
                    ...
                    <select name="select_status" class="form-control">
                        ...
                        <option id="{{$or->order_id}}" selected value="1">Chưa xử
                            lý</option>
                        <option id="{{$or->order_id}}" value="2">Đã xử lý-Đã giao
                            hàng</option>
                        <option id="{{$or->order_id}}" value="3">Hủy đơn hàng-tạm
                            giữ</option>
                        ...
                        <option id="{{$or->order_id}}" value="2">Đã xử lý-Đã giao
                            hàng</option>
                        <option id="{{$or->order_id}}" selected value="3">Hủy đơn hàngtạm giữ</option>
                        @endif
                    </select>
                    @endforeach
                </div>
                <div class="form-group col-sm-6">
                    <button type="submit" name="update_order" class="btn btn-info formcontrol">cập nhật đơn hàng
                    </button>
                </div>
            </form>
        </div>
