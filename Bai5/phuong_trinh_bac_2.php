...
<body>
    <form action="phuong_trinh_bac_2.php" method="post">
        <table width="806" border="1">
            <tr>
                <td colspan="4" bgcolor="#90e0ef"><strong>Giải phương trình bậc 2</strong></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="4">
                    ...
                    <input name="textfield" type="text" id="textfield2" style="width: 400px;" value="<?php if(isset($nghiem)) echo $nghiem ?>" />
            </tr>
            <tr>
