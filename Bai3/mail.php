...
if (isset($_POST)) {
    ...
    try {
      //  $mail->SMTPDebug = 2;  // 0,1,2: chế độ debug. khi mọi cấu hình đều tớt thì chỉnh lại 0 nhé
        ...
        $nguoigui = 'tungtt2.21it@vku.udn.vn';
        $matkhau = 'bhldmyskdtqjnsmk'; // đã tạo ở bước 3
        $tennguoigui = 'TUNG CHUONG';
        ...
        $recipients = "dunglm.21it@vku.udn.vn,nhatdnm.21it@vku.udn.vn,viennv.21it@vku.udn.vn,nguyennvv.21it@vku.udn.vn,thaolt.21it@vku.udn.vn,nganhtm.21it@vku.udn.vn,yenpn.21it@vku.udn.vn";
